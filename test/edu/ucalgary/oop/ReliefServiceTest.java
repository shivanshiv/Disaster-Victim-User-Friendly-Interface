...
public class ReliefServiceTest {
    ...
    private String validDate = "2025-10-31";
    private String invalidDate = "2025/10/31";
    private String expectedInfoProvided = "Looking for family member";
    private String expectedLogDetails = "Inquirer: John, Missing Person: Jane Alex, Date of Inquiry: 2025-10-31, Info Provided: Looking for family member, Last Known Location: University of Calgary";
